...
public class Visualizer extends JFrame implements ActionListener {
    ...
    QuickSort qs = new QuickSort();  // Adding QuickSort
    BucketSort bucketSort = new BucketSort(); // Adding BucketSort
    ...
    public Visualizer() throws InterruptedException {
        ...
        name = new JLabel("Developed by: Bhojraj");
        ...
        // Drop-down menu
        algorithms = new JComboBox<String>(new String[]{"Select Algorithm", "Bubble Sort", "Bucket Sort", "Heap Sort", "Insertion Sort", "Merge Sort", "Quick Sort"});
    ...
    public void actionPerformed(ActionEvent event) {
        if (event.getSource() == algorithms) {
            ...
            } else if (algorithms.getSelectedItem() == "Bucket Sort") {
                sortingAlgo = 't';
                timeComplexity.setText("Time Complexity: O(n + k)");
            ...
            } else if (sortingAlgo == 't') {
                try {
                    bucketSort.sort(heights, rectArr, this);
                    sorted = true;
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
